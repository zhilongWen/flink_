 ...
 * @create 2022-11-13
 */
public class LocalBatchStatementExecutor<T, V> implements ClickHouseBatchStatementExecutor<T> {

    private static final Logger LOG = LoggerFactory.getLogger(LocalBatchStatementExecutor.class);
    ...
    public LocalBatchStatementExecutor(
            String sql,
