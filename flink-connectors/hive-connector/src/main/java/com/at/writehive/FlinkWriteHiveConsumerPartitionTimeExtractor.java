...
//                + "    -- 'scan.startup.mode' = 'latest-offset',\n"
        ...
        String hiveSinkSQL = "create table if not exists hive_stream_create_flink_consumer_partition_time_extractor_tbl(\n"
                + "       id bigint,\n"
                + "       name string,\n"
                + "       address string,\n"
                + "       ts bigint\n"
                ...
                + "    STORED AS ORC\n"
                + "    LOCATION '/warehouse/test/hive_stream_create_flink_consumer_partition_time_extractor_tbl'\n"
                + "    TBLPROPERTIES (\n"
                + "        'orc.compress' = 'snappy',\n"
//                + "        'partition.time-extractor.timestamp-pattern'='$dt $hr:$mm:00',\n"
                + "        'partition.time-extractor.kind'='custom',\n"
                + "        'partition.time-extractor.class'='com.at.writehive.FlinkWriteHiveConsumerPartitionTimeExtractor$ConsumerPartitionTimeExtractor',\n"
        ...
        String insertSQL = "insert into hive_stream_create_flink_consumer_partition_time_extractor_tbl\n"
                + "select\n"
                + "    id,\n"
                + "    name,\n"
                + "    address,\n"
    ...
    // org.apache.flink.connector.file.table.DefaultPartTimeExtractor
    public static class ConsumerPartitionTimeExtractor implements PartitionTimeExtractor{
