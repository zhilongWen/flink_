...
public class FlinkMultiplexedWriter_1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // {"user_id":1,"action":"search","timestamp":1751555895000,"details":"1"} 2025-07-03 23:18:15
        // {"user_id":2,"action":"search","timestamp":1751555895000,"details":"1"} 2025-07-03 23:18:15
        // {"user_id":3,"action":"search","timestamp":1751555895000,"details":"1"} 2025-07-03 23:18:15
        KafkaSource<String> kafkaSource = KafkaSource.<String>builder()
                .setBootstrapServers("hadoop102:9092,hadoop103:9092,hadoop104:9092")
                .setTopics("multiplexed_writer_1")
                .setGroupId("FlinkMultiplexedWriter")
...
//        sourceDataStream.print();
        ...
        // 执行任务
        env.execute("FlinkMultiplexedWriter_1");
    }
}
