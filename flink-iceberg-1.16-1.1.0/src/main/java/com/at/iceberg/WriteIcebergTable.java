 ...
 * @author wenzhilong
 */
public class WriteIcebergTable {
...
//        env.getCheckpointConfig().enableUnalignedCheckpoints();
        ...
        checkpointConfig.set(CheckpointingOptions.CHECKPOINTS_DIRECTORY, "hdfs://10.211.55.102:8020/tmp/checkpoints/WriteIcebergTable");
        env.configure(checkpointConfig);

        KafkaSource<String> source = KafkaSource.<String>builder()
                .setBootstrapServers("hadoop102:9092,hadoop103:9092,hadoop104:9092")
                .setTopics("user_behaviors")
                .setGroupId("WriteIcebergTable")
//                .setStartingOffsets(OffsetsInitializer.earliest())
        ...
        // hdfs://10.211.55.102:8020/user/hive/warehouse/iceberg_db.db/iceberg_hadoop/default/user_behavior_flink_1
        ...
        TableIdentifier tableIdentifier = TableIdentifier.of("default", "user_behavior_flink_1");
...
//                PartitionSpec.builderFor(schema).build(),
        ...
        //        TableLoader tableLoader = TableLoader.fromHadoopTable("hdfs://10.211.55.102:8020/user/hive/warehouse/iceberg_db.db/iceberg_hadoop/default/user_behavior_flink_1");
